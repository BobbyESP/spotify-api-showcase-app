...
import com.bobbyesp.spotifyapishowcaseapp.ui.components.others.SearchingResult
import com.bobbyesp.spotifyapishowcaseapp.ui.components.others.shimmer.HorizontalSongCardShimmer
import com.bobbyesp.spotifyapishowcaseapp.ui.components.text.AnimatedCounter
import com.bobbyesp.spotifyapishowcaseapp.ui.components.text.QueryTextBox
import com.bobbyesp.spotifyapishowcaseapp.ui.pages.search.SearchViewModel.Companion
import com.bobbyesp.spotifyapishowcaseapp.util.ext.secondOrNull
import com.bobbyesp.spotifyapishowcaseapp.util.pagination.loadStateContent
            ...
            with(viewState) {
                when (this.searchViewState) {
                    is Companion.SearchViewState.Idle -> {
                        Text(text = stringResource(id = R.string.idle))
                    }
